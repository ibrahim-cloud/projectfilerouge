...
<?php  include('admin/ServerAdmin.php'); ?>
<!doctype html>
                            ...
                            <div class="col-xl-10 offset-xl-1">
                                <div class="property_wrap">
                                        <div class="slider_text text-center justify-content-center">
                                                <h3>Find a home near your school</h3>
                                            </div>
        ...
        while($rowS = mysqli_fetch_array($resultsS)) { 
         ...
         <div class="single_property">
             <div class="property_thumb">
                 ...
                 <img src="oxford-hero.jpg" alt="">
             </div>
             <div class="property_content">
                 <div class="main_pro">
                         <h3><a href="Nschool.php?idA='.$rowS['name'].'">'.$rowS['name'].'</a></h3>
                         <div class="mark_pro">
                             <img src="img/svg_icon/location.svg" alt="">
                             <span>Popular Properties</span>
                         </div>
                         <span class="amount">'.$rowS['address'].'</span>
                 </div>
             </div>
