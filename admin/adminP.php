...
<body>
    ...
    <tbody>
    <?php 
   $resultsF = mysqli_query($db, "SELECT * FROM add_house");
   while ($rowF = mysqli_fetch_array($resultsF)) { ?>
      <tr style="background-color: #001D38; color: aliceblue;">
      <td style="text-align: center;" class="column4"> <a href="adminP.php?edit=<?php echo $rowF['id']; ?>" class="genric-btn info">edit</a> </td>
                                    <td style="text-align: center;" class="column4">	<a href="adminP.php?delA=<?php echo $rowF['id']; ?>"class="genric-btn danger">Delete</a></td>
                        ...
                        <form  method="POST" action="ServerAdmin.php"  class="form-contact contact_form"  id="contactForm" >
                            <div class="row">
                               ...
                               <div class="mt-10">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    <input class="single-input" type="file" id="email"  name="img" value="<?php echo $img; ?>" id="message" cols="30" rows="9" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter img'" placeholder=" img">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
